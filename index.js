...
let numFlavors = is31Flavors(originalFlavors.length);
...
let newFlavorIndex = getFlavorByIndex(originalFlavors, 2);

console.log(newFlavorIndex);
...
function removeFlavorByName(a, b) {
  let removed = a.splice(b, 1);
  return a;
}

originalFlavors = removeFlavorByName(
  originalFlavors,
  originalFlavors.indexOf("Vanilla")
);
